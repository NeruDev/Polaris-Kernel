...
def generate():
    ...
    axs[0].plot(np.append(eq_pts[:,0], eq_pts[0,0]), np.append(eq_pts[:,1], eq_pts[0,1]), color=colors["primary"], lw=2)
    ...
    axs[1].plot(np.append(iso_pts[:,0], iso_pts[0,0]), np.append(iso_pts[:,1], iso_pts[0,1]), color=colors["secondary"], lw=2)
    ...
    axs[2].plot(np.append(esc_pts[:,0], esc_pts[0,0]), np.append(esc_pts[:,1], esc_pts[0,1]), color=colors["accent"], lw=2)
