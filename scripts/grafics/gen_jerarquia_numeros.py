# yaml_frontmatter:
#   id: 'gen_jerarquia_numeros'
#   title: 'Generador de grafico de jerarquia numerica en Typst'
#   tags: ['scripts', 'graphics', 'typst', 'numeros']
...
def main():
    ...
    svg_file = project_root / "src" / "01_fundamentos_logica" / "jerarquia_numeros.svg"
