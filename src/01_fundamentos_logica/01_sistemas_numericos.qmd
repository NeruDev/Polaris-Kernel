...
date: "2026-04-26"
categories: [numeros, conjuntos, reales]
...
#align(center)[#cetz.canvas({
  import cetz.draw: *
  line((-4, 0), (4, 0), mark: (end: ">", start: ">"))
  for x in range(-3, 4) {
    line((x, -0.2), (x, 0.2))
    content((x, -0.6), [#x])
  }
  content((1.5, 1), text(fill: rgb("39C5BB"), [$NN$]))
  content((-1.5, 1), text(fill: rgb("FF1493"), [$ZZ$]))
  content((3, 1), text(fill: rgb("10b981"), [$RR$]))
})]
```
