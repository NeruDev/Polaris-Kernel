...
date: "2026-04-26"
categories: [banach, hilbert, operadores, espacios_funcionales]
...
#align(center)[#cetz.canvas({
  ...
  content((3.3, 0), [$M$])
  circle((1, 2), radius: 0.1, fill: rgb("FF1493"))
  content((1, 2.4), [$x$])
  line((1,2), (1,0), stroke: (dash: "dashed"), mark: (end: ">"))
  circle((1, 0), radius: 0.1, fill: rgb("39C5BB"))
  content((1, -0.4), [$P_M(x)$])
  line((1,0), (1.3,0), (1.3,0.3), (1,0.3))
})]
```
