...
date: "2026-04-26"
categories: [edo, laplace, primer_orden, superior]
...
![Campo de pendientes para EDO primer orden](edo_campo_direcciones.svg)


Una ecuación diferencial es una relación entre una función desconocida y sus 
derivadas.
Son el lenguaje natural de la física, la biología y la ingeniería 
...
aceleración.
Las **EDO lineales con coeficientes constantes** son las más 
