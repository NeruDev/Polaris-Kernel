...
date: "2026-04-26"
categories: [trigonometria, identidad, triangulos, ondas]
...
#align(center)[#cetz.canvas({
  ...
  import cetz.plot
  plot.plot(size: (6, 3), {
    plot.add(domain: (-3.14, 3.14), x => calc.sin(x * 1rad), style: (stroke: rgb("39C5BB")))
    plot.add(domain: (-3.14, 3.14), x => calc.cos(x * 1rad), style: (stroke: rgb("FF1493")))
  })
})]
```
