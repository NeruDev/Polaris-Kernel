...
date: "2026-04-26"
categories: [variedades, curvas, curvatura, frenet]
...
#align(center)[#cetz.canvas({
  import cetz.draw: *
  bezier((-2,0), (2,0), (0,2), stroke: rgb("39C5BB") + 2pt)
  circle((0, 1), radius: 0.1, fill: rgb("FF1493"))
  line((-1.5, 1), (1.5, 1), stroke: rgb("10b981"))
  content((0, 1.3), [$p$])
  content((1.8, 1), [$T_p M$])
})]
```
