...
![Jerarquía de Grupos, Anillos y Campos](jerarquia_estructuras.svg)


El álgebra abstracta estudia las estructuras algebraicas por sí mismas, 
prescindiendo de la naturaleza de los elementos.
Se enfoca en las propiedades 
...
bajo el producto.
Ejemplos comunes son los números enteros $\mathbb{Z}$ y 
los polinomios.
