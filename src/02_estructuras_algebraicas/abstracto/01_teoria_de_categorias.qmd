...
date: "2026-04-26"
categories: [categorias, functores, morfismos, abstraccion]
...
![Morfismos y composición en categorías](diagrama_conmutativo.svg)
...
relaciones y transformaciones entre estructuras.
Es, en esencia, la 
...
Un **producto** de $A$ y $B$ es un objeto junto con 
proyecciones que cumplen una propiedad universal: cualquier otro objeto con 
mismo mapeo debe factorizarse a través del producto.
El **límite** generaliza 
...
Establecen que resolver un problema en una categoría 
