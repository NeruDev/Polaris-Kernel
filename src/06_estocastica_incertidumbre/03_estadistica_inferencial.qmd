...
date: "2026-04-26"
categories: [inferencia, hipotesis, intervalos, significancia]
...
#align(center)[#cetz.canvas({
  ...
  import cetz.plot
  plot.plot(size: (5, 3), {
    plot.add(domain: (-3, 3), x => calc.exp(-x*x), style: (stroke: rgb("39C5BB")))
    plot.add(domain: (-1.96, 1.96), x => calc.exp(-x*x), style: (fill: rgb("FF1493").transparentize(70%), stroke: none))
  })
})]
```
