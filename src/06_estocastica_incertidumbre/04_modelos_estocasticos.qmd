...
date: "2026-04-26"
categories: [markov, poisson, procesos, tiempo]
...
#align(center)[#cetz.canvas({
  import cetz.draw: *
  circle((0,0), radius: 0.5, name: "A", stroke: rgb("39C5BB"))
  circle((3,0), radius: 0.5, name: "B", stroke: rgb("FF1493"))
  content((0,0), [A])
  content((3,0), [B])
  bezier("A", "B", (1.5, 0.8), mark: (end: ">"))
  bezier("B", "A", (1.5, -0.8), mark: (end: ">"))
})]
```
