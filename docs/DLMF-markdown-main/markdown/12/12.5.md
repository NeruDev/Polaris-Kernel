...
$\Gamma\left(z\right)$: gamma function , $\pi$: the ratio of the circumference of a circle to its diameter , $\,\mathrm{d}x$: differential of $x$ , $\mathrm{e}$: base of natural logarithm , $\mathrm{i}$: imaginary unit , $\int$: integral , $U\left(a,z\right)$: parabolic cylinder function , $\operatorname{ph}$: phase , $z$: complex variable and $a$: real or complex parameter
...
$\Gamma\left(z\right)$: gamma function , $\pi$: the ratio of the circumference of a circle to its diameter , $\cosz$: cosine function , $\,\mathrm{d}x$: differential of $x$ , $\mathrm{e}$: base of natural logarithm , $\mathrm{i}$: imaginary unit , $\int$: integral , $V\left(a,z\right)$: parabolic cylinder function , $\operatorname{ph}$: phase , $z$: complex variable and $a$: real or complex parameter
