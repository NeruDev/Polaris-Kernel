...
<a id="E20"></a>
$$
\left\{z,\zeta\right\}=-2\dot{z}^{\frac{1}{2}}\frac{{\mathrm{d}}^{2}}{{\mathrm{d}\zeta}^{2}}(\dot{z}^{-\frac{1}{2}})=\frac{\dddot{z}}{\dot{z}}-\frac{3}{2}\left(\frac{\ddot{z}}{\dot{z}}\right)^{2}. \tag{1.13.20}
$$
...
$$
\displaystyle\left\{z,\zeta\right\} \displaystyle=(\frac{\mathrm{d}\xi}{\mathrm{d}\zeta})^{2}\left\{z,\xi\right\}+\left\{\xi,\zeta\right\}. \tag{1.13.21}
$$

:::{note}
**Symbols:**

$\left\{z,\zeta\right\}$: Schwarzian derivative , $\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $z$: variable , $\xi$: change of variable and $\zeta(z)$: thrice-differentiable function
...
$$
\displaystyle\left\{z,\zeta\right\} \displaystyle=-(\frac{\mathrm{d}z}{\mathrm{d}\zeta})^{2}\left\{\zeta,z\right\}. \tag{1.13.22}
$$

:::{note}
**Symbols:**

$\left\{z,\zeta\right\}$: Schwarzian derivative , $\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $z$: variable and $\zeta(z)$: thrice-differentiable function
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $z$: variable , $U(z)$: solution , $V(z)$: solution , $I$: coefficient and $J$: coefficient
...
$\,\mathrm{d}x$: differential of $x$ , $\int$: integral , $p(x)$: function , $\rho(x)$: function , $u(x)$: solution , $w(t)$: solution , $x$: real variable , $t$: real variable and $a$: real variable
