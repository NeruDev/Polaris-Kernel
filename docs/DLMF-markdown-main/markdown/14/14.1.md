...
| $\psi'\left(x\right)$ | $\frac{\mathrm{d}\psi\left(x\right)}{\mathrm{d}x}$ . |
| $\mathbf{F}\left(a,b;c;z\right)$ | Olver’s scaled hypergeometric function: $\frac{F\left(a,b;c;z\right)}{\Gamma\left(c\right)}$ . |
