...
$\pi$: the ratio of the circumference of a circle to its diameter , $\sinz$: sine function , $n$: integer and $z$: complex variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cosz$: cosine function , $n$: integer and $z$: complex variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cotz$: cotangent function , $n$: integer and $z$: complex variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cscz$: cosecant function , $n$: integer and $z$: complex variable
