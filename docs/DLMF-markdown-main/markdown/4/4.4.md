...
$\lnz$: principal branch of logarithm function
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\mathrm{i}$: imaginary unit and $\lnz$: principal branch of logarithm function
