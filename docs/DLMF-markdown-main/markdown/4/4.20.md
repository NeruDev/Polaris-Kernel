...
$\cosz$: cosine function , $\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\sinz$: sine function and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\secz$: secant function , $\tanz$: tangent function and $z$: complex variable
...
$\cscz$: cosecant function , $\cotz$: cotangent function , $\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ and $z$: complex variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\sinz$: sine function , $n$: integer and $z$: complex variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cosz$: cosine function , $\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $n$: integer and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $a$: real or complex constant and $z$: complex variable
...
$\cosz$: cosine function , $\sinz$: sine function , $a$: real or complex constant , $z$: complex variable , $A$: arbitrary constant and $B$: arbitrary constant
...
$\sinz$: sine function , $a$: real or complex constant , $z$: complex variable and $c$: arbitrary constant
...
$\tanz$: tangent function , $a$: real or complex constant , $z$: complex variable and $c$: arbitrary constant
