...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cscz$: cosecant function , $\cosz$: cosine function , $\cotz$: cotangent function , $\secz$: secant function , $\sinz$: sine function and $\tanz$: tangent function
