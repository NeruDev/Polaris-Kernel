...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{arcsin}z$: arcsine function and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{arccos}z$: arccosine function and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{arctan}z$: arctangent function and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{arccsc}z$: arccosecant function , $\Re$: real part and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{arcsec}z$: arcsecant function , $\Re$: real part and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{arccot}z$: arccotangent function and $z$: complex variable
