...
$\pi$: the ratio of the circumference of a circle to its diameter , $\operatorname{csch}z$: hyperbolic cosecant function , $\coshz$: hyperbolic cosine function , $\cothz$: hyperbolic cotangent function , $\operatorname{sech}z$: hyperbolic secant function , $\sinhz$: hyperbolic sine function , $\tanhz$: hyperbolic tangent function , $\mathrm{i}$: imaginary unit and $z$: complex variable
