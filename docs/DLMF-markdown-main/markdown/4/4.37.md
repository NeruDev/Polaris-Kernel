...
$\operatorname{Arcsinh}z$ : general inverse hyperbolic sine function
...
$\operatorname{Arccosh}z$ : general inverse hyperbolic cosine function
...
$\operatorname{Arctanh}z$ : general inverse hyperbolic tangent function
...
$\operatorname{Arccsch}z$ : general inverse hyperbolic cosecant function

**Symbols:**

$\operatorname{Arcsinh}z$: general inverse hyperbolic sine function and $z$: complex variable
...
$\operatorname{Arcsech}z$ : general inverse hyperbolic secant function

**Symbols:**

$\operatorname{Arccosh}z$: general inverse hyperbolic cosine function and $z$: complex variable
...
$\operatorname{Arccoth}z$ : general inverse hyperbolic cotangent function

**Symbols:**

$\operatorname{Arctanh}z$: general inverse hyperbolic tangent function and $z$: complex variable
...
$\operatorname{arccosh}z$ : inverse hyperbolic cosine function , $\operatorname{arcsinh}z$ : inverse hyperbolic sine function and $\operatorname{arctanh}z$ : inverse hyperbolic tangent function
...
$\operatorname{arccsch}z$ : inverse hyperbolic cosecant function

**Symbols:**

$\operatorname{arcsinh}z$: inverse hyperbolic sine function and $z$: complex variable
...
$\operatorname{arcsech}z$ : inverse hyperbolic secant function

**Symbols:**

$\operatorname{arccosh}z$: inverse hyperbolic cosine function and $z$: complex variable
...
$\operatorname{arccoth}z$ : inverse hyperbolic cotangent function

**Symbols:**

$\operatorname{arctanh}z$: inverse hyperbolic tangent function and $z$: complex variable
...
$\operatorname{arccsch}z$: inverse hyperbolic cosecant function , $\operatorname{arccosh}z$: inverse hyperbolic cosine function , $\operatorname{arccoth}z$: inverse hyperbolic cotangent function , $\operatorname{arcsech}z$: inverse hyperbolic secant function , $\operatorname{arcsinh}z$: inverse hyperbolic sine function , $\operatorname{arctanh}z$: inverse hyperbolic tangent function and $z$: complex variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\operatorname{arccosh}z$: inverse hyperbolic cosine function , $\Im$: imaginary part , $\mathrm{i}$: imaginary unit and $z$: complex variable
...
$\operatorname{arccsch}z$: inverse hyperbolic cosecant function and $z$: complex variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\operatorname{arcsech}z$: inverse hyperbolic secant function , $\Im$: imaginary part , $\mathrm{i}$: imaginary unit and $z$: complex variable
...
$\operatorname{arccoth}z$: inverse hyperbolic cotangent function and $z$: complex variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\operatorname{arcsinh}z$: inverse hyperbolic sine function , $\mathrm{i}$: imaginary unit , $\operatorname{Arcsinh}z$: general inverse hyperbolic sine function , $k$: integer and $z$: complex variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\operatorname{arccosh}z$: inverse hyperbolic cosine function , $\mathrm{i}$: imaginary unit , $\operatorname{Arccosh}z$: general inverse hyperbolic cosine function , $k$: integer and $z$: complex variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\operatorname{arctanh}z$: inverse hyperbolic tangent function , $\mathrm{i}$: imaginary unit , $\operatorname{Arctanh}z$: general inverse hyperbolic tangent function , $k$: integer and $z$: complex variable
