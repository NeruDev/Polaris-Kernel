...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\coshz$: hyperbolic cosine function , $\sinhz$: hyperbolic sine function and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{sech}z$: hyperbolic secant function , $\tanhz$: hyperbolic tangent function and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{csch}z$: hyperbolic cosecant function , $\cothz$: hyperbolic cotangent function and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $a$: real or complex constant , $z$: complex variable and $w$: solution
...
$\coshz$: hyperbolic cosine function , $\sinhz$: hyperbolic sine function , $a$: real or complex constant , $z$: complex variable , $w$: solution , $A$: arbitrary constant and $B$: arbitrary constant
...
$\sinhz$: hyperbolic sine function , $a$: real or complex constant , $z$: complex variable , $w$: solution and $c$: arbitrary constant
...
$\coshz$: hyperbolic cosine function , $a$: real or complex constant , $z$: complex variable , $w$: solution and $c$: arbitrary constant
...
$\cothz$: hyperbolic cotangent function , $a$: real or complex constant , $z$: complex variable , $w$: solution and $c$: arbitrary constant
