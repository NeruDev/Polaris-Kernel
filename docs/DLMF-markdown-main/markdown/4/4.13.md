...
$\operatorname{Wm}\left(x\right)$ : nonprincipal branch of Lambert $W$ -function , $\operatorname{Wp}\left(x\right)$ : principal branch of Lambert $W$ -function , $T\left(z\right)$ : Tree $T$ -function and $\omega\left(z\right)$ : Wright $\omega$ -function
...
$W\left(z\right)$: Lambert $W$-function , $\mathrm{i}$: imaginary unit and $x$: real variable
...
$W\left(z\right)$: Lambert $W$-function , $\pi$: the ratio of the circumference of a circle to its diameter , $\mathrm{e}$: base of natural logarithm , $\operatorname{ph}$: phase and $z$: complex variable
...
$W\left(z\right)$: Lambert $W$-function , $\mathrm{e}$: base of natural logarithm and $\mathrm{i}$: imaginary unit
...
<a id="E9_1"></a>
$$
W_{0}\left(z\right)=\sum_{n=0}^{\infty}d_{n}\left(\mathrm{e}z+1\right)^{\frac{n}{2}}, \tag{4.13.9_1}
$$
