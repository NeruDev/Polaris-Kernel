...
$\coshz$: hyperbolic cosine function and $\sinhz$: hyperbolic sine function
...
$\coshz$: hyperbolic cosine function , $\sinhz$: hyperbolic sine function and $\tanhz$: hyperbolic tangent function
...
$\cothz$: hyperbolic cotangent function and $\sinhz$: hyperbolic sine function
...
$\cosz$: cosine function , $\coshz$: hyperbolic cosine function , $\sinhz$: hyperbolic sine function , $\mathrm{i}$: imaginary unit , $\sinz$: sine function , $x$: real variable , $y$: real variable and $z$: complex variable
...
$\cosz$: cosine function , $\coshz$: hyperbolic cosine function , $\sinhz$: hyperbolic sine function , $\tanhz$: hyperbolic tangent function , $\mathrm{i}$: imaginary unit , $\sinz$: sine function , $x$: real variable , $y$: real variable and $z$: complex variable
...
$\cosz$: cosine function , $\coshz$: hyperbolic cosine function , $\cothz$: hyperbolic cotangent function , $\sinhz$: hyperbolic sine function , $\mathrm{i}$: imaginary unit , $\sinz$: sine function , $x$: real variable , $y$: real variable and $z$: complex variable
