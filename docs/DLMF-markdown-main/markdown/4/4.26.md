...
$\cosz$: cosine function , $\,\mathrm{d}x$: differential of $x$ , $\int$: integral , $\sinz$: sine function and $x$: real variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cosz$: cosine function , $\,\mathrm{d}x$: differential of $x$ , $\int$: integral , $\lnz$: principal branch of logarithm function , $\tanz$: tangent function and $x$: real variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cscz$: cosecant function , $\,\mathrm{d}x$: differential of $x$ , $\int$: integral , $\lnz$: principal branch of logarithm function , $\tanz$: tangent function and $x$: real variable
