...
$\mu\left(n\right)$: Möbius function , $\nu\left(n\right)$: number of distinct primes dividing a number , $d$: positive integer and $n$: positive integer
...
$\phi\left(n\right)$: Euler’s totient , $\mu\left(n\right)$: Möbius function , $d$: positive integer and $n$: positive integer
