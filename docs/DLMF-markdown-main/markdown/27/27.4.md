...
$\mu\left(n\right)$: Möbius function , $\zeta\left(s\right)$: Riemann zeta function , $\Re$: real part and $n$: positive integer
...
$\phi\left(n\right)$: Euler’s totient , $\zeta\left(s\right)$: Riemann zeta function , $\Re$: real part and $n$: positive integer
...
$\lambda\left(n\right)$: Liouville’s function , $\zeta\left(s\right)$: Riemann zeta function , $\Re$: real part and $n$: positive integer
...
$\zeta\left(s\right)$: Riemann zeta function , $\nu\left(n\right)$: number of distinct primes dividing a number , $\Re$: real part and $n$: positive integer
...
$\zeta\left(s\right)$: Riemann zeta function , $d_{k}\left(n\right)$: divisor function , $\Re$: real part , $k$: positive integer and $n$: positive integer
...
$\Lambda\left(n\right)$: Mangoldt’s function , $\zeta\left(s\right)$: Riemann zeta function , $\Re$: real part and $n$: positive integer
...
$\zeta\left(s\right)$: Riemann zeta function , $\lnz$: principal branch of logarithm function , $\Re$: real part and $n$: positive integer
