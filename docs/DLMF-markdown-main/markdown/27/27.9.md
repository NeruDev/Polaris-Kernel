...
$(n|P)$ : Jacobi symbol and $(n|p)$ : Legendre symbol
...
[$(n|p)$: Legendre symbol](./27.9.md "§27.9 Quadratic Characters ‣ Multiplicative Number Theory ‣ Chapter 27 Functions of Number Theory") and $p$: odd prime
