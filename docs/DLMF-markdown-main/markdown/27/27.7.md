...
$\phi\left(n\right)$: Euler’s totient , $n$: positive integer and $x$: real number
...
$\sigma_{\alpha}\left(n\right)$: sum of powers of divisors of a number , $n$: positive integer and $x$: real number
...
$\lambda\left(n\right)$: Liouville’s function , $n$: positive integer and $x$: real number
