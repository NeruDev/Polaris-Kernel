...
$\operatorname{Ai}\left(z\right)$: Airy function , $\operatorname{Bi}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $\,\mathrm{d}x$: differential of $x$ , $\int$: integral and $z$: complex variable
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\operatorname{Bi}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $\,\mathrm{d}x$: differential of $x$ , $\int$: integral , $\lnz$: principal branch of logarithm function and $z$: complex variable
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\Gamma\left(z\right)$: gamma function , $\pi$: the ratio of the circumference of a circle to its diameter , $\,\mathrm{d}x$: differential of $x$ and $\int$: integral
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\operatorname{Bi}\left(z\right)$: Airy function , $\Gamma\left(z\right)$: gamma function , $\pi$: the ratio of the circumference of a circle to its diameter , $\,\mathrm{d}x$: differential of $x$ and $\int$: integral
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $\,\mathrm{d}x$: differential of $x$ , $\int$: integral and $\lnz$: principal branch of logarithm function
