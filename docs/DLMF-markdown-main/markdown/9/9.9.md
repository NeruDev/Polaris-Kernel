...
$\beta_{k}$ : $k$ th complex zero of Airy $\operatorname{Bi}$ , $\beta^{\prime}_{k}$ : $k$ th complex zero of Airy $\operatorname{Bi}'$ , $a_{k}$ : $k$ th zero of Airy $\operatorname{Ai}$ , $b_{k}$ : $k$ th zero of Airy $\operatorname{Bi}$ , $a^{\prime}_{k}$ : $k$ th zero of Airy $\operatorname{Ai}'$ and $b^{\prime}_{k}$ : $k$ th zero of Airy $\operatorname{Bi}'$
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\phi\left(z\right)$: Airy phase function , $\theta\left(z\right)$: Airy phase function , $a_{k}$: $k$th zero of Airy $\operatorname{Ai}$ , $a^{\prime}_{k}$: $k$th zero of Airy $\operatorname{Ai}'$ and $k$: nonnegative integer
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\phi\left(z\right)$: Airy phase function , $\theta\left(z\right)$: Airy phase function , $b_{k}$: $k$th zero of Airy $\operatorname{Bi}$ , $b^{\prime}_{k}$: $k$th zero of Airy $\operatorname{Bi}'$ and $k$: nonnegative integer
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\operatorname{Bi}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $M\left(z\right)$: Airy modulus function , $a_{k}$: $k$th zero of Airy $\operatorname{Ai}$ , $b_{k}$: $k$th zero of Airy $\operatorname{Bi}$ and $k$: nonnegative integer
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\operatorname{Bi}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $N\left(z\right)$: Airy modulus function , $a^{\prime}_{k}$: $k$th zero of Airy $\operatorname{Ai}'$ , $b^{\prime}_{k}$: $k$th zero of Airy $\operatorname{Bi}'$ and $k$: nonnegative integer
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $a_{k}$: $k$th zero of Airy $\operatorname{Ai}$ , $a^{\prime}_{k}$: $k$th zero of Airy $\operatorname{Ai}'$ and $k$: nonnegative integer
...
$\pi$: the ratio of the circumference of a circle to its diameter , $a_{k}$: $k$th zero of Airy $\operatorname{Ai}$ , $k$: nonnegative integer and $T$: expansion
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $a_{k}$: $k$th zero of Airy $\operatorname{Ai}$ , $k$: nonnegative integer and $V$: expansion
...
$\pi$: the ratio of the circumference of a circle to its diameter , $a^{\prime}_{k}$: $k$th zero of Airy $\operatorname{Ai}'$ , $k$: nonnegative integer and $U$: expansion
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $a^{\prime}_{k}$: $k$th zero of Airy $\operatorname{Ai}'$ , $k$: nonnegative integer and $W$: expansion
...
$\pi$: the ratio of the circumference of a circle to its diameter , $b_{k}$: $k$th zero of Airy $\operatorname{Bi}$ , $k$: nonnegative integer and $T$: expansion
...
$\operatorname{Bi}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $b_{k}$: $k$th zero of Airy $\operatorname{Bi}$ , $k$: nonnegative integer and $V$: expansion
...
$\pi$: the ratio of the circumference of a circle to its diameter , $b^{\prime}_{k}$: $k$th zero of Airy $\operatorname{Bi}'$ , $k$: nonnegative integer and $U$: expansion
...
$\operatorname{Bi}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $b^{\prime}_{k}$: $k$th zero of Airy $\operatorname{Bi}'$ , $k$: nonnegative integer and $W$: expansion
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\beta_{k}$: $k$th complex zero of Airy $\operatorname{Bi}$ , $\mathrm{e}$: base of natural logarithm , $\mathrm{i}$: imaginary unit , $\lnz$: principal branch of logarithm function , $k$: nonnegative integer and $T$: expansion
...
$\operatorname{Bi}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $\beta_{k}$: $k$th complex zero of Airy $\operatorname{Bi}$ , $\mathrm{e}$: base of natural logarithm , $\mathrm{i}$: imaginary unit , $\lnz$: principal branch of logarithm function , $k$: nonnegative integer and $V$: expansion
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\beta^{\prime}_{k}$: $k$th complex zero of Airy $\operatorname{Bi}'$ , $\mathrm{e}$: base of natural logarithm , $\mathrm{i}$: imaginary unit , $\lnz$: principal branch of logarithm function , $k$: nonnegative integer and $U$: expansion
...
$\operatorname{Bi}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $\beta^{\prime}_{k}$: $k$th complex zero of Airy $\operatorname{Bi}'$ , $\mathrm{e}$: base of natural logarithm , $\mathrm{i}$: imaginary unit , $\lnz$: principal branch of logarithm function , $k$: nonnegative integer and $W$: expansion
...
$\operatorname{Ai}\left(z\right)$: Airy function , $a_{k}$: $k$th zero of Airy $\operatorname{Ai}$ , $a^{\prime}_{k}$: $k$th zero of Airy $\operatorname{Ai}'$ and $k$: nonnegative integer
...
$\operatorname{Bi}\left(z\right)$: Airy function , $b_{k}$: $k$th zero of Airy $\operatorname{Bi}$ , $b^{\prime}_{k}$: $k$th zero of Airy $\operatorname{Bi}'$ and $k$: nonnegative integer
...
$\operatorname{Bi}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $\beta_{k}$: $k$th complex zero of Airy $\operatorname{Bi}$ , $\mathrm{e}$: base of natural logarithm , $\mathrm{i}$: imaginary unit and $k$: nonnegative integer
...
$\operatorname{Bi}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $\beta^{\prime}_{k}$: $k$th complex zero of Airy $\operatorname{Bi}'$ , $\mathrm{e}$: base of natural logarithm , $\mathrm{i}$: imaginary unit and $k$: nonnegative integer
