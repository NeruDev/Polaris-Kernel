...
$\operatorname{Ai}\left(z\right)$: Airy function , $\sim$: asymptotic equality , $\pi$: the ratio of the circumference of a circle to its diameter , $\,\mathrm{d}x$: differential of $x$ , $\expz$: exponential function , $\int$: integral and $x$: real variable
...
$\operatorname{Bi}\left(z\right)$: Airy function , $\sim$: asymptotic equality , $\pi$: the ratio of the circumference of a circle to its diameter , $\,\mathrm{d}x$: differential of $x$ , $\expz$: exponential function , $\int$: integral and $x$: real variable
...
$\,\mathrm{d}x$: differential of $x$ , $\int$: integral , $z$: complex variable and $w$: ODE solution
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\,\mathrm{d}x$: differential of $x$ and $\int$: integral
...
<a id="E19"></a>
$$
\operatorname{Bi}\left(x\right)=\frac{3x^{5/4}e^{(2/3)x^{3/2}}}{2\pi}\,\fint_{0}^{\infty}\frac{t^{-3/4}e^{-(2/3)t^{3/2}}\operatorname{Ai}\left(t\right)}{x^{3/2}-t^{3/2}}\,\mathrm{d}t, \tag{9.10.19}
$$
