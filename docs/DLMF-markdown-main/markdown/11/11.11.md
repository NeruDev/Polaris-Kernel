...
$\mathbf{E}_{\nu}\left(z\right)$: Weber function , $\sim$: asymptotic equality , $\pi$: the ratio of the circumference of a circle to its diameter , $z$: complex variable and $n$: integer order
