...
$\sim$: Poincaré asymptotic expansion , $\cosz$: cosine function , $U\left(a,z\right)$: parabolic cylinder function , $\sinz$: sine function , $s$: nonnegative integer , $\kappa$ , $\widetilde{\mathcal{A}}_{s}(t)$: coefficients and $g(\mu)$: expansion
...
$\sim$: Poincaré asymptotic expansion , $\cosz$: cosine function , $U\left(a,z\right)$: parabolic cylinder function , $\sinz$: sine function , $s$: nonnegative integer , $\kappa$ , $\widetilde{\mathcal{B}}_{s}(t)$: coefficients and $g(\mu)$: expansion
...
$\Gamma\left(z\right)$: gamma function , $\sim$: Poincaré asymptotic expansion , $\cosz$: cosine function , $V\left(a,z\right)$: parabolic cylinder function , $\sinz$: sine function , $s$: nonnegative integer , $\chi$ , $\widetilde{\mathcal{A}}_{s}(t)$: coefficients and $g(\mu)$: expansion
...
$\Gamma\left(z\right)$: gamma function , $\sim$: Poincaré asymptotic expansion , $\cosz$: cosine function , $V\left(a,z\right)$: parabolic cylinder function , $\sinz$: sine function , $s$: nonnegative integer , $\chi$ , $\widetilde{\mathcal{B}}_{s}(t)$: coefficients and $g(\mu)$: expansion
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\sim$: Poincaré asymptotic expansion , $\pi$: the ratio of the circumference of a circle to its diameter , $U\left(a,z\right)$: parabolic cylinder function , $s$: nonnegative integer , $\zeta$: change of variable , $\phi(\zeta)$: function , $C_{s}(\zeta)$: coefficients , $D_{s}(\zeta)$: coefficients and $g(\mu)$: expansion
...
$\operatorname{Bi}\left(z\right)$: Airy function , $\Gamma\left(z\right)$: gamma function , $\sim$: Poincaré asymptotic expansion , $\pi$: the ratio of the circumference of a circle to its diameter , $V\left(a,z\right)$: parabolic cylinder function , $s$: nonnegative integer , $\zeta$: change of variable , $\phi(\zeta)$: function , $A_{s}(\zeta)$: coefficients , $B_{s}(\zeta)$: coefficients and $g(\mu)$: expansion
...
$\operatorname{Bi}\left(z\right)$: Airy function , $\Gamma\left(z\right)$: gamma function , $\sim$: Poincaré asymptotic expansion , $\pi$: the ratio of the circumference of a circle to its diameter , $V\left(a,z\right)$: parabolic cylinder function , $s$: nonnegative integer , $\zeta$: change of variable , $\phi(\zeta)$: function , $C_{s}(\zeta)$: coefficients , $D_{s}(\zeta)$: coefficients and $g(\mu)$: expansion
