...
<a id="E4"></a>
$$
V\left(-\tfrac{1}{2},z\right)=(\frac{2}{\sqrt{\pi}}\,)e^{\frac{1}{4}z^{2}}F\left(z/\sqrt{2}\right), \tag{12.7.4}
$$
...
$\pi$: the ratio of the circumference of a circle to its diameter , $K_{\nu}\left(z\right)$: modified Bessel function of the second kind , $U\left(a,z\right)$: parabolic cylinder function and $z$: complex variable
