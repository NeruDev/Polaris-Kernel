...
$U\left(a,z\right)$: parabolic cylinder function , $z$: complex variable and $a$: real or complex parameter
...
$V\left(a,z\right)$: parabolic cylinder function , $z$: complex variable and $a$: real or complex parameter
