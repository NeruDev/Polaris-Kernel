...
$U\left(a,z\right)$ : parabolic cylinder function and $V\left(a,z\right)$ : parabolic cylinder function
...
$\Gamma\left(z\right)$: gamma function , $\pi$: the ratio of the circumference of a circle to its diameter , $U\left(a,z\right)$: parabolic cylinder function and $a$: real or complex parameter
...
$\Gamma\left(z\right)$: gamma function , $\pi$: the ratio of the circumference of a circle to its diameter , $V\left(a,z\right)$: parabolic cylinder function and $a$: real or complex parameter
...
$\overline{U}\left(a,x\right)$ : parabolic cylinder function
