...
$U\left(a,z\right)$: parabolic cylinder function , $x$: real variable and $a$: real or complex parameter
...
$U\left(a,z\right)$: parabolic cylinder function , $\overline{U}\left(a,x\right)$: parabolic cylinder function , $x$: real variable and $F(a,x)$: modulus
...
$\mathrm{i}$: imaginary unit , $U\left(a,z\right)$: parabolic cylinder function , $x$: real variable and $y$: real variable
