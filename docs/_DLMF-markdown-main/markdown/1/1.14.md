...
The following table summarizes the changes that were made to the notation for integral transforms throughout the DLMF. Notation for Integral Transforms Transform New Notation Abbreviated Notation Old Notation Fourier $\mathscr{F}\left(f\right)\left(x\right)$ $\mathscr{F}\mspace{-3.0mu}f\mspace{3.0mu}\left(x\right)$ Fourier Cosine $\mathscr{F}_{\mkern-3.0muc}\left(f\right)\left(x\right)$ $\mathscr{F}_{\mkern-3.0muc}\mspace{-1.0mu}f\mspace{3.0mu}\left(x\right)$ Fourier Sine $\mathscr{F}_{\mkern-2.0mus}\left(f\right)\left(x\right)$ $\mathscr{F}_{\mkern-2.0mus}\mspace{-1.0mu}f\mspace{3.0mu}\left(x\right)$ Laplace $\mathscr{L}\left(f\right)\left(s\right)$ $\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)$ $\mathscr{L}(f(t);s)$ Mellin $\mathscr{M}\left(f\right)\left(s\right)$ $\mathscr{M}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)$ $\mathscr{M}(f;s)$ Hilbert $\mathcal{H}\left(f\right)\left(s\right)$ $\mathcal{H}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)$ $\mathcal{H}(f;s)$ Stieltjes $\mathcal{S}\left(f\right)\left(s\right)$ $\mathcal{S}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)$ $\mathcal{S}(f;s)$
...
|---|---|---|---|
| **Fourier** | **$\mathscr{F}\left(f\right)\left(x\right)$** | **$\mathscr{F}\mspace{-3.0mu}f\mspace{3.0mu}\left(x\right)$** |   |
| **Fourier Cosine** | **$\mathscr{F}_{\mkern-3.0muc}\left(f\right)\left(x\right)$** | **$\mathscr{F}_{\mkern-3.0muc}\mspace{-1.0mu}f\mspace{3.0mu}\left(x\right)$** |   |
| **Fourier Sine** | **$\mathscr{F}_{\mkern-2.0mus}\left(f\right)\left(x\right)$** | **$\mathscr{F}_{\mkern-2.0mus}\mspace{-1.0mu}f\mspace{3.0mu}\left(x\right)$** |   |
| **Laplace** | **$\mathscr{L}\left(f\right)\left(s\right)$** | **$\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)$** | **$\mathscr{L}(f(t);s)$** |
| **Mellin** | **$\mathscr{M}\left(f\right)\left(s\right)$** | **$\mathscr{M}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)$** | **$\mathscr{M}(f;s)$** |
| **Hilbert** | **$\mathcal{H}\left(f\right)\left(s\right)$** | **$\mathcal{H}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)$** | **$\mathcal{H}(f;s)$** |
| **Stieltjes** | **$\mathcal{S}\left(f\right)\left(s\right)$** | **$\mathcal{S}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)$** | **$\mathcal{S}(f;s)$** |
...
<a id="E1"></a>
$$
\mathscr{F}\left(f\right)\left(x\right)=\mathscr{F}\mspace{-3.0mu}f\mspace{3.0mu}\left(x\right)=\frac{1}{\sqrt{2\pi}}\int^{\infty}_{-\infty}f(t){\mathrm{e}}^{\mathrm{i}xt}\,\mathrm{d}t. \tag{1.14.1}
$$
...
<a id="E3"></a>
$$
\tfrac{1}{2}(f(u+)+f(u-))=\frac{1}{\sqrt{2\pi}}\fint^{\infty}_{-\infty}F(x){\mathrm{e}}^{-\mathrm{i}xu}\,\mathrm{d}x, \tag{1.14.3}
$$
...
$$
\displaystyle\mathscr{F}_{\mkern-3.0muc}\left(f\right)\left(x\right) \displaystyle=\mathscr{F}_{\mkern-3.0muc}\mspace{-1.0mu}f\mspace{3.0mu}\left(x\right)=\sqrt{\frac{2}{\pi}}\int^{\infty}_{0}f(t)\cos\left(xt\right)\,\mathrm{d}t, \tag{1.14.9}
$$

:::{note}
**Defines:**

$\mathscr{F}_{\mkern-3.0muc}\left(f\right)\left(s\right)$ : Fourier cosine transform

**Symbols:**

$\pi$: the ratio of the circumference of a circle to its diameter , $\cosz$: cosine function , $\,\mathrm{d}x$: differential of $x$ , $\int$: integral and $F_{c}(x)$: cosine transformation of $f(t)$
...
This equation defines the general notation $\mathscr{F}_{\mkern-3.0muc}\left(f\right)\left(x\right)$ or $\mathscr{F}_{\mkern-3.0muc}\mspace{-1.0mu}f\mspace{3.0mu}\left(x\right)$ . Previously it defined the local notation $F_{c}(x)$ used in this subsection.
...
$$
\displaystyle\mathscr{F}_{\mkern-2.0mus}\left(f\right)\left(x\right) \displaystyle=\mathscr{F}_{\mkern-2.0mus}\mspace{-1.0mu}f\mspace{3.0mu}\left(x\right)=\sqrt{\frac{2}{\pi}}\int^{\infty}_{0}f(t)\sin\left(xt\right)\,\mathrm{d}t. \tag{1.14.10}
$$

:::{note}
**Defines:**

$\mathscr{F}_{\mkern-2.0mus}\left(f\right)\left(s\right)$ : Fourier sine transform

**Symbols:**

$\pi$: the ratio of the circumference of a circle to its diameter , $\,\mathrm{d}x$: differential of $x$ , $\int$: integral , $\sinz$: sine function and $F_{s}(x)$: sine transformation of $f(t)$
...
This equation defines the general notation $\mathscr{F}_{\mkern-2.0mus}\left(f\right)\left(x\right)$ or $\mathscr{F}_{\mkern-2.0mus}\mspace{-1.0mu}f\mspace{3.0mu}\left(x\right)$ . Previously it defined the local notation $F_{s}(x)$ used in this subsection.
...
In this subsection we let $F_{c}(x)=\mathscr{F}_{\mkern-3.0muc}\mspace{-1.0mu}f\mspace{3.0mu}\left(x\right)$ , $F_{s}(x)=\mathscr{F}_{\mkern-2.0mus}\mspace{-1.0mu}f\mspace{3.0mu}\left(x\right)$ , $G_{c}(x)=\mathscr{F}_{\mkern-3.0muc}\mspace{-1.0mu}g\mspace{3.0mu}\left(x\right)$ , and $G_{s}(x)=\mathscr{F}_{\mkern-2.0mus}\mspace{-1.0mu}g\mspace{3.0mu}\left(x\right)$ .
...
$\,\mathrm{d}x$: differential of $x$ , $\int$: integral , $F_{c}(x)$: cosine transformation of $f(t)$ and $G_{c}(x)$: cosine transformation of $g(t)$
...
$\,\mathrm{d}x$: differential of $x$ , $\int$: integral , $F_{s}(x)$: sine transformation of $f(t)$ and $G_{s}(x)$: sine transformation of $g(t)$
...
$\,\mathrm{d}x$: differential of $x$ , $\int$: integral and $F_{c}(x)$: cosine transformation of $f(t)$
...
$\,\mathrm{d}x$: differential of $x$ , $\int$: integral and $F_{s}(x)$: sine transformation of $f(t)$
...
<a id="E17"></a>
$$
\mathscr{L}\left(f\right)\left(s\right)=\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)=\int^{\infty}_{0}{\mathrm{e}}^{-st}f(t)\,\mathrm{d}t. \tag{1.14.17}
$$
...
Then $\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)$ is an analytic function of $s$ for $\Re s>\alpha$ . Moreover,


<a id="E19"></a>
$$
\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)\to 0, \tag{1.14.19}
$$
...
<a id="E20"></a>
$$
f(t)=\frac{1}{2\pi\mathrm{i}}\lim_{T\to\infty}\int^{\sigma+\mathrm{i}T}_{\sigma-\mathrm{i}T}{\mathrm{e}}^{ts}\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)\,\mathrm{d}s, \tag{1.14.20}
$$

Moreover, if $\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)=O\left(s^{-K}\right)$ in some half-plane $\Re s\geq\gamma$ and $K>1$ , then ( 1.14.20 ) holds for $\sigma>\gamma$ .
...
<a id="E21"></a>
$$
\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(s-a\right)=\mathscr{L}\mspace{-3.0mu}f_{a}\mspace{3.0mu}\left(s\right), \tag{1.14.21}
$$
...
<a id="E22"></a>
$$
\mathscr{L}\mspace{-3.0mu}f_{a}^{+}\mspace{3.0mu}\left(s\right)={\mathrm{e}}^{-as}\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right), \tag{1.14.22}
$$
...
<a id="E23"></a>
$$
{(-1)}^{n}\frac{{\mathrm{d}}^{n}}{{\mathrm{d}s}^{n}}\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)=\mathscr{L}\mspace{-3.0mu}f_{n}\mspace{3.0mu}\left(s\right), \tag{1.14.23}
$$
...
<a id="E24"></a>
$$
\int^{\infty}_{s}\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(u\right)\,\mathrm{d}u=\mathscr{L}\mspace{-3.0mu}f_{-1}\mspace{3.0mu}\left(s\right), \tag{1.14.24}
$$
...
<a id="E25"></a>
$$
\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)=\frac{1}{1-{\mathrm{e}}^{-as}}\int^{a}_{0}{\mathrm{e}}^{-st}f(t)\,\mathrm{d}t. \tag{1.14.25}
$$
...
<a id="E26"></a>
$$
\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)=\frac{1}{1+{\mathrm{e}}^{-as}}\int^{a}_{0}{\mathrm{e}}^{-st}f(t)\,\mathrm{d}t. \tag{1.14.26}
$$
...
If $f(t)$ and $g(t)$ are continuous and $\mathscr{L}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)=\mathscr{L}\mspace{-3.0mu}g\mspace{3.0mu}\left(s\right)$ , then $f(t)=g(t)$ .
...
<a id="E32"></a>
$$
\mathscr{M}\left(f\right)\left(s\right)=\mathscr{M}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)=\int^{\infty}_{0}x^{s-1}f(x)\,\mathrm{d}x. \tag{1.14.32}
$$

If $x^{\sigma-1}f(x)$ is integrable on $(0,\infty)$ for all $\sigma$ in $a<\sigma<b$ , then the integral ( 1.14.32 ) converges and $\mathscr{M}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)$ is an analytic function of $s$ in the vertical strip $a<\Re s<b$ . Moreover, for $a<\sigma<b$ ,


<a id="E33"></a>
$$
\lim_{t\to\pm\infty}\mathscr{M}\mspace{-3.0mu}f\mspace{3.0mu}\left(\sigma+\mathrm{i}t\right)=0. \tag{1.14.33}
$$
...
<a id="E34"></a>
$$
\tfrac{1}{2}(f(u+)+f(u-))=\frac{1}{2\pi\mathrm{i}}\lim_{T\to\infty}\int^{\sigma+\mathrm{i}T}_{\sigma-\mathrm{i}T}u^{-s}\mathscr{M}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)\,\mathrm{d}s. \tag{1.14.34}
$$

If $f(x)$ is continuous on $(0,\infty)$ and $\mathscr{M}\mspace{-3.0mu}f\mspace{3.0mu}\left(\sigma+\mathrm{i}t\right)$ is integrable on $(-\infty,\infty)$ , then


<a id="E35"></a>
$$
f(x)=\frac{1}{2\pi\mathrm{i}}\int^{\sigma+\mathrm{i}\infty}_{\sigma-\mathrm{i}\infty}x^{-s}\mathscr{M}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)\,\mathrm{d}s. \tag{1.14.35}
$$
...
Suppose $x^{-\sigma}f(x)$ and $x^{\sigma-1}g(x)$ are absolutely integrable on $(0,\infty)$ and either $\mathscr{M}\mspace{-3.0mu}g\mspace{3.0mu}\left(\sigma+\mathrm{i}t\right)$ or $\mathscr{M}\mspace{-3.0mu}f\mspace{3.0mu}\left(1-\sigma-\mathrm{i}t\right)$ is absolutely integrable on $(-\infty,\infty)$ . Then for $y>0$ ,


<a id="E36"></a>
$$
\int^{\infty}_{0}f(x)g(yx)\,\mathrm{d}x=\frac{1}{2\pi\mathrm{i}}\,\int^{\sigma+\mathrm{i}\infty}_{\sigma-\mathrm{i}\infty}y^{-s}\mathscr{M}\mspace{-3.0mu}f\mspace{3.0mu}\left(1-s\right)\mathscr{M}\mspace{-3.0mu}g\mspace{3.0mu}\left(s\right)\,\mathrm{d}s, \tag{1.14.36}
$$


<a id="E37"></a>
$$
\int^{\infty}_{0}f(x)g(x)\,\mathrm{d}x=\frac{1}{2\pi\mathrm{i}}\,\int^{\sigma+\mathrm{i}\infty}_{\sigma-\mathrm{i}\infty}\mathscr{M}\mspace{-3.0mu}f\mspace{3.0mu}\left(1-s\right)\mathscr{M}\mspace{-3.0mu}g\mspace{3.0mu}\left(s\right)\,\mathrm{d}s. \tag{1.14.37}
$$
...
<a id="E38"></a>
$$
\int^{\infty}_{0}(f(x))^{2}\,\mathrm{d}x=\frac{1}{2\pi}\int^{\infty}_{-\infty}{\left|\mathscr{M}\mspace{-3.0mu}f\mspace{3.0mu}\left(\tfrac{1}{2}+\mathrm{i}t\right)\right|}^{2}\,\mathrm{d}t. \tag{1.14.38}
$$
...
<a id="E40"></a>
$$
\int^{\infty}_{0}x^{s-1}(f*g)(x)\,\mathrm{d}x=\mathscr{M}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)\mathscr{M}\mspace{-3.0mu}g\mspace{3.0mu}\left(s\right). \tag{1.14.40}
$$
...
$\mathcal{H}\left(f\right)\left(x\right)$ : Hilbert transform
...
$$
\displaystyle\mathcal{H}\left(f\right)\left(x\right) \displaystyle=\mathcal{H}\mspace{-3.0mu}f\mspace{3.0mu}\left(x\right)=\frac{1}{\pi}\fint^{\infty}_{-\infty}\frac{f(t)}{t-x}\,\mathrm{d}t, \tag{1.14.41}
$$

:::{note}
**Symbols:**

$\mathcal{H}\left(f\right)\left(x\right)$: Hilbert transform , $\pi$: the ratio of the circumference of a circle to its diameter , $\,\mathrm{d}x$: differential of $x$ and $\fint_{a}^{b}$: Cauchy principal value

**Notational Change (effective with 1.0.15):**

The notation for the Hilbert transform was changed to $\mathcal{H}\left(f\right)\left(x\right)$ or $\mathcal{H}\mspace{-3.0mu}f\mspace{3.0mu}\left(x\right)$ from $\mathcal{H}(f;x)$ .
...
$$
\displaystyle\mathcal{H}\mspace{-3.0mu}f\mspace{3.0mu}\left(x\right) \displaystyle=\lim_{y\to 0+}\frac{1}{\pi}\int^{\infty}_{-\infty}\frac{t-x}{(t-x)^{2}+y^{2}}f(t)\,\mathrm{d}t, \tag{1.14.42}
$$

:::{note}
**Symbols:**

$\mathcal{H}\left(f\right)\left(x\right)$: Hilbert transform , $\pi$: the ratio of the circumference of a circle to its diameter , $\,\mathrm{d}x$: differential of $x$ and $\int$: integral

**Notational Change (effective with 1.0.15):**

The notation for the Hilbert transform was changed to $\mathcal{H}\mspace{-3.0mu}f\mspace{3.0mu}\left(x\right)$ from $\mathcal{H}(f;x)$ .
...
$$
\displaystyle\mathcal{H}\mspace{-3.0mu}f\mspace{3.0mu}\left(x\right) \displaystyle=\lim_{\epsilon\to 0+}\frac{1}{\pi}\int^{\infty}_{\epsilon}\frac{f(x+t)-f(x-t)}{t}\,\mathrm{d}t. \tag{1.14.43}
$$
...
<a id="E44"></a>
$$
f(x)=-\frac{1}{\pi}\fint^{\infty}_{-\infty}\frac{\mathcal{H}\mspace{-3.0mu}f\mspace{3.0mu}\left(u\right)}{u-x}\,\mathrm{d}u. \tag{1.14.44}
$$
...
If ${\left|f(t)\right|}^{p}$ , $p>1$ , is integrable on $(-\infty,\infty)$ , then so is ${\left|\mathcal{H}\mspace{-3.0mu}f\mspace{3.0mu}\left(x\right)\right|}^{p}$ and


<a id="E45"></a>
$$
\int^{\infty}_{-\infty}{\left|\mathcal{H}\mspace{-3.0mu}f\mspace{3.0mu}\left(x\right)\right|}^{p}\,\mathrm{d}x\leq A_{p}\int^{\infty}_{-\infty}{\left|f(t)\right|}^{p}\,\mathrm{d}t, \tag{1.14.45}
$$
...
<a id="E46"></a>
$$
\frac{1}{\sqrt{2\pi}}\int_{-\infty}^{\infty}\mathcal{H}\mspace{-3.0mu}f\mspace{3.0mu}\left(u\right){\mathrm{e}}^{\mathrm{i}ux}\,\mathrm{d}u=-\mathrm{i}(\operatorname{sign}x)\mathscr{F}\mspace{-3.0mu}f\mspace{3.0mu}\left(x\right), \tag{1.14.46}
$$

where $\mathscr{F}\mspace{-3.0mu}f\mspace{3.0mu}\left(x\right)$ is given by ( 1.14.1 ).
...
<a id="E47"></a>
$$
\mathcal{S}\left(f\right)\left(s\right)=\mathcal{S}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)=\int^{\infty}_{0}\frac{f(t)}{s+t}\,\mathrm{d}t. \tag{1.14.47}
$$
...
If the integral converges, then it converges uniformly in any compact domain in the complex $s$ -plane not containing any point of the interval $(-\infty,0]$ . In this case, $\mathcal{S}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)$ represents an analytic function in the $s$ -plane cut along the negative real axis, and


<a id="E48"></a>
$$
\frac{{\mathrm{d}}^{m}}{{\mathrm{d}s}^{m}}\mathcal{S}\mspace{-3.0mu}f\mspace{3.0mu}\left(s\right)=(-1)^{m}m!\int^{\infty}_{0}\frac{f(t)\,\mathrm{d}t}{(s+t)^{m+1}}, \tag{1.14.48}
$$
...
<a id="E49"></a>
$$
\lim_{t\to 0+}\frac{\mathcal{S}\mspace{-3.0mu}f\mspace{3.0mu}\left(-\sigma-\mathrm{i}t\right)-\mathcal{S}\mspace{-3.0mu}f\mspace{3.0mu}\left(-\sigma+\mathrm{i}t\right)}{2\pi\mathrm{i}}=\tfrac{1}{2}(f(\sigma+)+f(\sigma-)), \tag{1.14.49}
$$
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cosz$: cosine function , $\,\mathrm{d}x$: differential of $x$ , $\mathrm{e}$: base of natural logarithm , $\coshz$: hyperbolic cosine function , $\sinhz$: hyperbolic sine function , $\mathrm{i}$: imaginary unit , $\int$: integral , $\sinz$: sine function and $\left|x\right|$: absolute value of $x$
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cosz$: cosine function , $\,\mathrm{d}x$: differential of $x$ , $\mathrm{e}$: base of natural logarithm , $\int$: integral , $\lnz$: principal branch of logarithm function , $\Re$: real part and $\sinz$: sine function
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\,\mathrm{d}x$: differential of $x$ , $\mathrm{e}$: base of natural logarithm , $\int$: integral , $\operatorname{arctan}z$: arctangent function , $\lnz$: principal branch of logarithm function , $\operatorname{ph}$: phase , $\Re$: real part , $\sinz$: sine function and $\left|x\right|$: absolute value of $x$
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cosz$: cosine function , $\,\mathrm{d}x$: differential of $x$ , $\mathrm{e}$: base of natural logarithm , $!$: factorial (as in $n!$) , $\coshz$: hyperbolic cosine function , $\sinhz$: hyperbolic sine function , $\Im$: imaginary part , $\int$: integral , $\operatorname{arctan}z$: arctangent function , $\lnz$: principal branch of logarithm function , $\Re$: real part , $\sinz$: sine function , $n$: nonnegative integer and $\left|x\right|$: absolute value of $x$
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cscz$: cosecant function , $\cosz$: cosine function , $\cotz$: cotangent function , $\,\mathrm{d}x$: differential of $x$ , $\int$: integral , $\operatorname{arccot}z$: arccotangent function , $\operatorname{arctan}z$: arctangent function , $\lnz$: principal branch of logarithm function , $\operatorname{ph}$: phase , $\Re$: real part , $\secz$: secant function , $\sinz$: sine function , $\tanz$: tangent function and $\left|x\right|$: absolute value of $x$
