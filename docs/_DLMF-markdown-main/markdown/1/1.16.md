...
$\left\langle\Lambda,\phi\right\rangle$ : action of distribution on test function
...
$\delta_{x}$: Dirac delta distribution , $\left\langle\Lambda,\phi\right\rangle$: action of distribution on test function , $\in$: element of , $\phi(x)$: test function , $I$: interval and $\mathcal{D}(I)$: test function space
...
$\delta_{x}$: Dirac delta distribution , $\left\langle\Lambda,\phi\right\rangle$: action of distribution on test function , $\in$: element of , $n$: nonnegative integer , $\phi(x)$: test function , $I$: interval and $\mathcal{D}(I)$: test function space
...
$H\left(x\right)$ : Heaviside function
...
$H\left(x\right)$: Heaviside function , $\delta_{x}$: Dirac delta distribution and $Df$: distributional derivative
...
<a id="E49"></a>
$$
\left\langle\mathscr{F}\left(\operatorname{sign}\right),\phi\right\rangle=\mathrm{i}\sqrt{\frac{2}{\pi}}\fint^{\infty}_{-\infty}\frac{\phi(x)}{x}\,\mathrm{d}x. \tag{1.16.49}
$$
...
<a id="E51"></a>
$$
\left\langle\mathscr{F}\left(H\right),\phi\right\rangle=\sqrt{\frac{\pi}{2}}\phi(0)+\frac{\mathrm{i}}{\sqrt{2\pi}}\fint^{\infty}_{-\infty}\frac{\phi(x)}{x}\,\mathrm{d}x. \tag{1.16.51}
$$
