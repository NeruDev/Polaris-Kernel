...
$\chi\left(n\right)$ : Dirichlet character
...
$\chi\left(n\right)$: Dirichlet character and $k$: positive integer
...
$\chi\left(n\right)$: Dirichlet character , $k$: positive integer , $m$: positive integer and $n$: positive integer
...
$\chi\left(n\right)$: Dirichlet character , $k$: positive integer and $n$: positive integer
...
$\chi\left(n\right)$: Dirichlet character , $\left(m,n\right)$: greatest common divisor (gcd) , $k$: positive integer and $n$: positive integer
