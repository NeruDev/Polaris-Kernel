...
$\phi\left(n\right)$: Euler’s totient , $n$: positive integer and $p,p_{1},\ldots$: prime numbers
...
$J_{k}\left(n\right)$: Jordan’s function , $k$: positive integer , $n$: positive integer and $p,p_{1},\ldots$: prime numbers
...
$d_{k}\left(n\right)$: divisor function , $\nu\left(n\right)$: number of distinct primes dividing a number , $n$: positive integer and $a_{r}$: positive exponent
...
$\sigma_{\alpha}\left(n\right)$: sum of powers of divisors of a number , $\nu\left(n\right)$: number of distinct primes dividing a number , $n$: positive integer , $p,p_{1},\ldots$: prime numbers and $a_{r}$: positive exponent
