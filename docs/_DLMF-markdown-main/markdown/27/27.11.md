...
$O\left(x\right)$: order not exceeding , $\pi$: the ratio of the circumference of a circle to its diameter , $\sigma_{\alpha}\left(n\right)$: sum of powers of divisors of a number , $\lnz$: principal branch of logarithm function , $n$: positive integer and $x$: real number
...
$O\left(x\right)$: order not exceeding , $\zeta\left(s\right)$: Riemann zeta function , $\sigma_{\alpha}\left(n\right)$: sum of powers of divisors of a number , $n$: positive integer and $x$: real number
...
$O\left(x\right)$: order not exceeding , $\phi\left(n\right)$: Euler’s totient , $\pi$: the ratio of the circumference of a circle to its diameter , $\lnz$: principal branch of logarithm function , $n$: positive integer and $x$: real number
