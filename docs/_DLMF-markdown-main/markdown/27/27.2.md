...
$d_{k}\left(n\right)$ : divisor function and $\nu\left(n\right)$ : number of distinct primes dividing a number
...
$\phi\left(n\right)$: Euler’s totient , $d_{k}\left(n\right)$: divisor function , $\sigma_{\alpha}\left(n\right)$: sum of powers of divisors of a number and $n$: positive integer
