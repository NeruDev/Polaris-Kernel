...
$\operatorname{log}_{a}z$ : logarithm to general base
...
$\operatorname{log}_{a}z$: logarithm to general base , $\lnz$: principal branch of logarithm function , $a$: real or complex constant and $z$: complex variable
...
$\operatorname{log}_{a}z$: logarithm to general base , $a$: real or complex constant and $z$: complex variable
...
$\operatorname{log}_{a}z$: logarithm to general base and $a$: real or complex constant
...
<a id="E15"></a>
$$
\operatorname{log}_{10}z=\frac{(\ln z)}{(\ln 10)}=(\operatorname{log}_{10}e)\ln z, \tag{4.2.15}
$$
