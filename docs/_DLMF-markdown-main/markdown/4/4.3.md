...
$\mathrm{e}$: base of natural logarithm , $\lnz$: principal branch of logarithm function , $(a,b)$: open interval , $x$: real variable and $y$: real variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\overline{z}$: complex conjugate , $\mathrm{e}$: base of natural logarithm , $\mathrm{i}$: imaginary unit , $\lnz$: principal branch of logarithm function , $z$: complex variable , $w$: mapping and $r$: real parameter
...
$\mathrm{i}$: imaginary unit , $\lnz$: principal branch of logarithm function , $x$: real variable and $y$: real variable
