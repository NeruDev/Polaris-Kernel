...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{arcsinh}z$: inverse hyperbolic sine function and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{arccosh}z$: inverse hyperbolic cosine function , $\Re$: real part and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{arctanh}z$: inverse hyperbolic tangent function and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{arccsch}z$: inverse hyperbolic cosecant function , $\Re$: real part and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{arcsech}z$: inverse hyperbolic secant function and $z$: complex variable
...
$\frac{\mathrm{d}f}{\mathrm{d}x}$: derivative of $f$ with respect to $x$ , $\operatorname{arccoth}z$: inverse hyperbolic cotangent function and $z$: complex variable
