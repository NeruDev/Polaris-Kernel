...
$\,\mathrm{d}x$: differential of $x$ , $\coshz$: hyperbolic cosine function , $\sinhz$: hyperbolic sine function , $\int$: integral and $x$: real variable
...
$\,\mathrm{d}x$: differential of $x$ , $\coshz$: hyperbolic cosine function , $\tanhz$: hyperbolic tangent function , $\int$: integral , $\lnz$: principal branch of logarithm function and $x$: real variable
...
$\,\mathrm{d}x$: differential of $x$ , $\operatorname{csch}z$: hyperbolic cosecant function , $\tanhz$: hyperbolic tangent function , $\int$: integral , $\lnz$: principal branch of logarithm function and $x$: real variable
...
$\operatorname{gd}x$: Gudermannian function , $\,\mathrm{d}x$: differential of $x$ , $\operatorname{sech}z$: hyperbolic secant function , $\int$: integral and $x$: real variable
