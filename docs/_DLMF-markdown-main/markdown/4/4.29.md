...
$\coshz$: hyperbolic cosine function , $\sinhz$: hyperbolic sine function and $x$: real variable
...
$\cothz$: hyperbolic cotangent function , $\tanhz$: hyperbolic tangent function and $x$: real variable
...
$\operatorname{csch}z$: hyperbolic cosecant function , $\operatorname{sech}z$: hyperbolic secant function and $x$: real variable
