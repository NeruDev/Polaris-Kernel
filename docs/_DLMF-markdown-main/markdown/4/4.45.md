...
$\left\lfloorx\right\rfloor$: floor of $x$ , $\lnz$: principal branch of logarithm function , $m$: integer , $x$: real variable and $y$: real variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\left\lfloorx\right\rfloor$: floor of $x$ and $m$: integer
...
$\cosz$: cosine function , $\sinz$: sine function , $m$: integer and $x$: real variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\mathrm{i}$: imaginary unit , $\lnz$: principal branch of logarithm function , $\operatorname{ph}$: phase and $z$: complex variable
...
$\cosz$: cosine function , $\mathrm{e}$: base of natural logarithm , $\Im$: imaginary part , $\mathrm{i}$: imaginary unit , $\Re$: real part , $\sinz$: sine function and $z$: complex variable
