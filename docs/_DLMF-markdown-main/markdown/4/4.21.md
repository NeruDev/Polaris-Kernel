...
$\cosz$: cosine function , $\sinz$: sine function and $\tanz$: tangent function
...
$\cosz$: cosine function , $\,\mathrm{d}x$: differential of $x$ , $\sinz$: sine function and $z$: complex variable
