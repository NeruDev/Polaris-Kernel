...
$\cosz$: cosine function , $\sinz$: sine function and $x$: real variable
...
$\cotz$: cotangent function , $\tanz$: tangent function and $x$: real variable
...
$\cscz$: cosecant function , $\secz$: secant function and $x$: real variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\overline{z}$: complex conjugate , $\coshz$: hyperbolic cosine function , $\sinhz$: hyperbolic sine function , $\mathrm{i}$: imaginary unit , $\operatorname{arcsin}z$: arcsine function , $\sinz$: sine function , $z$: complex variable , $w$: mapping and $r$: real parameter
...
$\mathrm{i}$: imaginary unit , $\sinz$: sine function , $x$: real variable and $y$: real variable
...
$\mathrm{i}$: imaginary unit , $\tanz$: tangent function , $x$: real variable and $y$: real variable
...
$\cscz$: cosecant function , $\mathrm{i}$: imaginary unit , $x$: real variable and $y$: real variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cosz$: cosine function , $\mathrm{i}$: imaginary unit , $\sinz$: sine function , $x$: real variable and $y$: real variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cotz$: cotangent function , $\mathrm{i}$: imaginary unit , $\tanz$: tangent function , $x$: real variable and $y$: real variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $\cscz$: cosecant function , $\mathrm{i}$: imaginary unit , $\secz$: secant function , $x$: real variable and $y$: real variable
