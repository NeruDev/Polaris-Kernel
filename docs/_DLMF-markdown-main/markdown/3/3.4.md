...
<a id="E2"></a>
$$
B_{k}^{n}=\frac{\mathrm{d}A_{k}^{n}}{\mathrm{d}t}, \tag{3.4.2}
$$
...
$\frac{\partialf}{\partialx}$: partial derivative of $f$ with respect to $x$ , $\,\partialx$: partial differential of $x$ and $u$: function
...
$O\left(x\right)$: order not exceeding and $u$: function
...
$O\left(x\right)$: order not exceeding , $\frac{\partialf}{\partialx}$: partial derivative of $f$ with respect to $x$ , $\,\partialx$: partial differential of $x$ and $u$: function
...
$O\left(x\right)$: order not exceeding , $\,\partialx$: partial differential of $x$ and $u$: function
