...
$\mathbf{E}_{\nu}\left(z\right)$: Weber function , $\sim$: asymptotic equality and $\pi$: the ratio of the circumference of a circle to its diameter
...
$\mathbf{E}_{\nu}\left(z\right)$: Weber function , $w_{n}$: sequence , $p_{n}$: solutions and $e_{n}$: sequence
