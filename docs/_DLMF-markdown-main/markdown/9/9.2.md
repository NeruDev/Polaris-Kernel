...
$\operatorname{Ai}\left(z\right)$ : Airy function and $\operatorname{Bi}\left(z\right)$ : Airy function
...
$\operatorname{Ai}\left(z\right)$: Airy function and $\Gamma\left(z\right)$: gamma function
...
$\operatorname{Bi}\left(z\right)$: Airy function and $\Gamma\left(z\right)$: gamma function
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\operatorname{Bi}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $\mathrm{e}$: base of natural logarithm , $\mathrm{i}$: imaginary unit , $\operatorname{ph}$: phase , $x$: real variable and $z$: complex variable
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $\mathrm{e}$: base of natural logarithm , $\mathrm{i}$: imaginary unit and $z$: complex variable
...
$\operatorname{Ai}\left(z\right)$: Airy function , $\operatorname{Bi}\left(z\right)$: Airy function , $\pi$: the ratio of the circumference of a circle to its diameter , $\mathrm{e}$: base of natural logarithm , $\mathrm{i}$: imaginary unit and $z$: complex variable
...
$W=(1/w)\frac{\mathrm{d}w}{\mathrm{d}z}$ , where $w$ is any nontrivial solution of ( 9.2.1 ). See also Smith ([1990](./bib/S.html#bib2125 "A Riccati approach to the Airy equation")).
