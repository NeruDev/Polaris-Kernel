...
$\operatorname{Ai}\left(z\right)$: Airy function , $!$: factorial (as in $n!$) and $z$: complex variable
...
$\operatorname{Bi}\left(z\right)$: Airy function , $!$: factorial (as in $n!$) and $z$: complex variable
