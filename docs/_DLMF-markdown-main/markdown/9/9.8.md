...
$\operatorname{Ai}\left(z\right)$: Airy function , $M\left(z\right)$: Airy modulus function , $\theta\left(z\right)$: Airy phase function , $\sinz$: sine function and $x$: real variable
...
$\operatorname{Bi}\left(z\right)$: Airy function , $\cosz$: cosine function , $M\left(z\right)$: Airy modulus function , $\theta\left(z\right)$: Airy phase function and $x$: real variable
...
$M\left(z\right)$ : Airy modulus function

**Symbols:**

$\operatorname{Ai}\left(z\right)$: Airy function , $\operatorname{Bi}\left(z\right)$: Airy function , $x$: real variable and $z$: complex variable
...
$\theta\left(z\right)$ : Airy phase function

**Symbols:**

$\operatorname{Ai}\left(z\right)$: Airy function , $\operatorname{Bi}\left(z\right)$: Airy function , $\operatorname{arctan}z$: arctangent function , $x$: real variable and $z$: complex variable
...
$\operatorname{Ai}\left(z\right)$: Airy function , $N\left(z\right)$: Airy modulus function , $\phi\left(z\right)$: Airy phase function , $\sinz$: sine function and $x$: real variable
...
$\operatorname{Bi}\left(z\right)$: Airy function , $\cosz$: cosine function , $N\left(z\right)$: Airy modulus function , $\phi\left(z\right)$: Airy phase function and $x$: real variable
...
$N\left(z\right)$ : Airy modulus function
...
$\phi\left(z\right)$ : Airy phase function
...
$J_{\nu}\left(z\right)$: Bessel function of the first kind , $Y_{\nu}\left(z\right)$: Bessel function of the second kind , $M\left(z\right)$: Airy modulus function , $x$: real variable and $\xi$: change of variable
...
$J_{\nu}\left(z\right)$: Bessel function of the first kind , $Y_{\nu}\left(z\right)$: Bessel function of the second kind , $N\left(z\right)$: Airy modulus function , $x$: real variable and $\xi$: change of variable
...
$J_{\nu}\left(z\right)$: Bessel function of the first kind , $Y_{\nu}\left(z\right)$: Bessel function of the second kind , $\pi$: the ratio of the circumference of a circle to its diameter , $\operatorname{arctan}z$: arctangent function , $\theta\left(z\right)$: Airy phase function , $x$: real variable and $\xi$: change of variable
...
$J_{\nu}\left(z\right)$: Bessel function of the first kind , $Y_{\nu}\left(z\right)$: Bessel function of the second kind , $\pi$: the ratio of the circumference of a circle to its diameter , $\operatorname{arctan}z$: arctangent function , $\phi\left(z\right)$: Airy phase function , $x$: real variable and $\xi$: change of variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $M\left(z\right)$: Airy modulus function , $N\left(z\right)$: Airy modulus function , $\phi\left(z\right)$: Airy phase function , $\theta\left(z\right)$: Airy phase function and $x$: real variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $M\left(z\right)$: Airy modulus function , $N\left(z\right)$: Airy modulus function , $\theta\left(z\right)$: Airy phase function and $x$: real variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $M\left(z\right)$: Airy modulus function , $N\left(z\right)$: Airy modulus function , $\phi\left(z\right)$: Airy phase function and $x$: real variable
...
$\pi$: the ratio of the circumference of a circle to its diameter , $M\left(z\right)$: Airy modulus function and $x$: real variable
...
$\sim$: Poincaré asymptotic expansion , $\pi$: the ratio of the circumference of a circle to its diameter , $!$: factorial (as in $n!$) , $M\left(z\right)$: Airy modulus function and $x$: real variable
...
$\sim$: Poincaré asymptotic expansion , $\pi$: the ratio of the circumference of a circle to its diameter , $!$: factorial (as in $n!$) , $N\left(z\right)$: Airy modulus function and $x$: real variable
...
$\sim$: Poincaré asymptotic expansion , $\pi$: the ratio of the circumference of a circle to its diameter , $\theta\left(z\right)$: Airy phase function and $x$: real variable
...
$\sim$: Poincaré asymptotic expansion , $\pi$: the ratio of the circumference of a circle to its diameter , $\phi\left(z\right)$: Airy phase function and $x$: real variable
